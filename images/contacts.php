          ...
          <div class="row navigation">
            <nav>
              <ul class="sf-menu">
               ...
               <li><a href="promoçao.html">promoçao</a></li>
  ...
  <div class="zerogrid">
    ...
    <div class="row">
	    <div class="col-2-5"><div class="wrap-col">
	      ...
	      E-mail: <a href="mailto:dropibiofc@gmail.com">dropibiofc@gmail.com</a>
	    </div></div>
	    <div class="col-3-5"><div class="wrap-col">
	      <h4 class="color1 inset__1">Contact Form</h4>
	        <div id="contact_form">
				...
				<form name="form1" id="ff" method="post" action="contato.php">
					 <label>
					 Name*:
...
<footer id="footer">
  <div class="zerogrid">
    <div class="col-full"><div class="wrap-col">
      <div class="sub-copy">zMOVE &copy; <span id="copyright-year"></span> | <a href="#">Privacy Policy</a> <br> Designed by <a href="http://www.templatemonster.com/" rel="nofollow">TemplateMonster</a> - <a href="https://www.zerotheme.com/" title="free website templates">ZEROTHEME</a> </div>
    </div></div>
  </div>
</footer>
